 ...
 * 河南大学认证
 */
public class HenuCasLoginProcess extends OcrLoginProcess {
    public HenuCasLoginProcess(String loginUrl, Map<String, String> params) {
        super(loginUrl, params, CasLoginEntityBuilder.class);
        loginEntity.setNeedcaptchaUrl("https://ids.henu.edu.cn/authserver/checkNeedCaptcha.htl");
        loginEntity.setCaptchaUrl("https://ids.henu.edu.cn/authserver/getCaptcha.htl");
    }
    ...
    public Map<String, String> login() throws Exception {
        ...
        headers.put("Host", "ids.henu.edu.cn");
...
//        System.out.println(doc);
        ...
        if (form == null) {
            throw new RuntimeException("网页中没有找到loginFromId，可能是教务系统已经更新，请联系开发者。");
        }
...
//                System.out.println(code);
    ...
    protected Map<String, String> casSendLoginData(String login_url, Map<String, String> cookies, Map<String, String> params) throws Exception {
        ...
        headers.put("Host", "ids.henu.edu.cn");
        headers.put("Origin", "https://ids.henu.edu.cn");
        headers.put("Referer", "https://ids.henu.edu.cn/authserver/login?service=https%3A%2F%2Fhenu.campusphere.net%2Fportal%2Flogin");
        headers.put("Upgrade-Insecure-Requests", "1");
        headers.put("User-Agent", "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.125 Safari/537.36");
